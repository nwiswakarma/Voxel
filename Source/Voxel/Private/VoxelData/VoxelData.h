...
public:
	...
	*/
	 ...
	 */
	void GetDiffLists(std::forward_list<FVoxelValueDiff>& OutValueDiffList, std::forward_list<FVoxelMaterialDiff>& OutMaterialDiffList);
...
private:
	TSharedPtr<FValueOctree> MainOctree;
