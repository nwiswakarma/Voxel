...
public:
	...
	std::list<FVoxelChunkSave> GetChunksList() const;
};
...
UCLASS(Blueprintable, BlueprintType, Category = Voxel)
class VOXEL_API UVoxelMeshSave : public USaveGame
{
	GENERATED_BODY()
